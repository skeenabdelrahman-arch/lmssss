...
<body>
    ...
    <div class="warning-note">
        <i class="fas fa-exclamation-triangle"></i> هذا الامتحان لا يحتوي على الإجابات - للاستخدام كامتحان للطلاب
    </div>
    ...
    <div class="question-card">
        ...
        <div class="answer-space">
            مساحة للإجابة: _________________________
        </div>
    ...
    <div style="text-align: center; margin-top: 40px; padding: 20px; color: #6c757d; font-size: 14px;">
        ...
        <p style="color: #dc3545; font-weight: 600; margin-top: 10px;">⚠️ هذا الملف لا يحتوي على الإجابات الصحيحة</p>
    </div>
