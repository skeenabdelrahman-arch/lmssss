        ...
        <div class="card-body">
            ...
            <div class="form-check form-switch mb-4">
                <input
                    ...
                    value="1"
                    {{ ($settings['video_tracking_enabled'] ?? '1') == '1' ? 'checked' : '' }}
                >
...
<div id="videoCompletionWrapper"
     class="fade-toggle mt-3 {{ ($settings['video_tracking_enabled'] ?? '1') == '1' ? 'visible' : 'hidden' }}">
    ...
    <div class="input-group">
        ...
        <input
            ...
            value="{{ $settings['video_completion_percentage'] ?? '80' }}"
            min="0"
            max="100"
            step="1"
        >
                ...
                <div class="card-body-modern">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="teacher_name" name="teacher_name" 
                               value="{{ $settings['teacher_name'] ?? '' }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="teacher_full_name" name="teacher_full_name" 
                               value="{{ $settings['teacher_full_name'] ?? '' }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="subject_name" name="subject_name" 
                               value="{{ $settings['subject_name'] ?? '' }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="subject_description" name="subject_description" rows="2">{{ $settings['subject_description'] ?? '' }}</textarea>
            ...
            <div class="modern-card mb-4">
                ...
                <div class="card-body-modern">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="color" class="form-control form-control-color" id="primary_color" 
                                   name="primary_color" value="{{ $settings['primary_color'] ?? '#7424a9' }}" required>
                            <input type="text" class="form-control" id="primary_color_text" 
                                   value="{{ $settings['primary_color'] ?? '#7424a9' }}" readonly>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="color" class="form-control form-control-color" id="secondary_color" 
                                   name="secondary_color" value="{{ $settings['secondary_color'] ?? '#fa896b' }}" required>
                            <input type="text" class="form-control" id="secondary_color_text" 
                                   value="{{ $settings['secondary_color'] ?? '#fa896b' }}" readonly>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-2">
                            <img src="{{ asset($settings['logo_path']) }}" alt="Logo" style="max-height: 100px; border-radius: 10px;">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-2">
                            <img src="{{ asset($settings['favicon_path']) }}" alt="Favicon" style="max-height: 32px; border-radius: 5px;">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="site_keywords" name="site_keywords" 
                               value="{{ $settings['site_keywords'] ?? '' }}" placeholder="مثال: أحياء, ثانوية عامة, دروس">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="whatsapp_number" name="whatsapp_number" 
                               value="{{ $settings['whatsapp_number'] ?? '' }}" placeholder="+201014506018">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="phone_number" name="phone_number" 
                               value="{{ $settings['phone_number'] ?? '' }}" placeholder="01014506018">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" id="facebook_url" name="facebook_url" 
                               value="{{ $settings['facebook_url'] ?? '' }}" placeholder="https://facebook.com/username">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" id="instagram_url" name="instagram_url" 
                               value="{{ $settings['instagram_url'] ?? '' }}" placeholder="https://instagram.com/username">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" id="youtube_url" name="youtube_url" 
                               value="{{ $settings['youtube_url'] ?? '' }}" placeholder="https://youtube.com/channel/...">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
        ...
        <div class="card-body-modern">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="hero_quote" name="hero_quote" 
                       value="{{ $settings['hero_quote'] ?? '' }}" placeholder='" وما رميت إذ رميت ولكن الله رمى "'>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="hero_title" name="hero_title" 
                       value="{{ $settings['hero_title'] ?? '' }}" placeholder="الأحياء مع الأستاذ سامح صلاح">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="hero_subtitle" name="hero_subtitle" 
                       value="{{ $settings['hero_subtitle'] ?? '' }}" placeholder="خبير تدريس مادة الأحياء">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="hero_additional_text" name="hero_additional_text" rows="3" 
                          placeholder="أهلاً بك في منصتنا – كل الشرح والامتحانات في مكان واحد">{{ $settings['hero_additional_text'] ?? '' }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="cta_text_1" name="cta_text_1" 
                               value="{{ $settings['cta_text_1'] ?? 'جروب التيلجرام' }}" placeholder="جروب التيلجرام">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" id="cta_link_1" name="cta_link_1" 
                               value="{{ $settings['cta_link_1'] ?? '' }}" placeholder="https://t.me/...">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="cta_text_2" name="cta_text_2" 
                               value="{{ $settings['cta_text_2'] ?? 'تعرف على المزيد' }}" placeholder="تعرف على المزيد">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" id="cta_link_2" name="cta_link_2" 
                               value="{{ $settings['cta_link_2'] ?? '' }}" placeholder="https://...">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="cta_text_3" name="cta_text_3" 
                               value="{{ $settings['cta_text_3'] ?? 'تواصل معنا' }}" placeholder="تواصل معنا">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="url" class="form-control" id="cta_link_3" name="cta_link_3" 
                               value="{{ $settings['cta_link_3'] ?? '' }}" placeholder="https://...">
        ...
        <div class="card-body-modern">
            <div class="mb-3">
                ...
                <textarea class="form-control" id="teacher_bio" name="teacher_bio" rows="4" 
                          placeholder="اكتب سيرة ذاتية مختصرة عن المدرس...">{{ $settings['teacher_bio'] ?? '' }}</textarea>
    ...
    <div class="modern-card mb-4">
        ...
        <div class="card-body-modern">
            <div class="mb-3">
                ...
                @endphp
                @if($teacherImagePath && file_exists(public_path($teacherImagePath)))
                <div class="mt-2">
                    <img src="{{ asset($teacherImagePath) }}" alt="صورة المدرس" style="max-height: 150px; border-radius: 10px; border: 2px solid var(--primary-color);">
                    <small class="d-block text-muted mt-1">الصورة الحالية</small>
                </div>
                @elseif(isset($settings['teacher_image']) && $settings['teacher_image'])
                <div class="mt-2">
                    <img src="{{ asset($settings['teacher_image']) }}" alt="صورة المدرس" style="max-height: 150px; border-radius: 10px; border: 2px solid var(--primary-color);">
                    <small class="d-block text-muted mt-1">الصورة الحالية</small>
                </div>
                @endif
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="about_teacher_bio" name="about_teacher_bio" rows="5" 
                          placeholder="مدرس لغة إنجليزية متخصص في تدريس الثانوية العامة بخبرة تمتد لأكثر من 15 عاماً...">{{ $settings['about_teacher_bio'] ?? '' }}</textarea>
            ...
            <div id="about-qualifications-container">
                ...
                @endphp
                @foreach($qualificationsData as $index => $qual)
                <div class="about-qualification-item mb-3 p-3 border rounded">
                    <div class="row g-3">
                        <div class="col-md-10">
                            <label class="form-label">النص</label>
                            <input type="text" name="about_qualifications[{{ $index }}][text]" 
                                   class="form-control" value="{{ $qual['text'] ?? '' }}" 
                                   placeholder="مثال: بكالوريوس آداب قسم اللغة الإنجليزية" required>
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">الأيقونة</label>
                            <input type="text" name="about_qualifications[{{ $index }}][icon]" 
                                   class="form-control" value="{{ $qual['icon'] ?? 'fa-check-circle' }}" 
                ...
                <div class="about-stat-item mb-3 p-3 border rounded">
                    <div class="row g-3">
                        <div class="col-md-5">
                            ...
                            <input type="text" name="about_stats[{{ $index }}][number]" 
                                   class="form-control" value="{{ $stat['number'] ?? '' }}" 
                                   placeholder="مثال: 15+" required>
                        </div>
                        <div class="col-md-5">
                            <label class="form-label">التسمية</label>
                            <input type="text" name="about_stats[{{ $index }}][label]" 
                                   class="form-control" value="{{ $stat['label'] ?? '' }}" 
                ...
                <div class="about-method-item mb-3 p-3 border rounded">
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="about_methods[{{ $index }}][title]" 
                                   class="form-control" value="{{ $method['title'] ?? '' }}" 
                                   placeholder="مثال: شرح مبسط وواضح" required>
                        </div>
                        <div class="col-md-12">
                            <label class="form-label">الوصف</label>
                            <textarea name="about_methods[{{ $index }}][description]" 
                                      class="form-control" rows="2" 
                                      placeholder="مثال: تبسيط القواعد والمفاهيم المعقدة..." required>{{ $method['description'] ?? '' }}</textarea>
                        </div>
                    </div>
                ...
                <div class="about-review-item mb-3 p-3 border rounded">
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <textarea name="about_reviews[{{ $index }}][text]" 
                                      class="form-control" rows="2" 
                                      placeholder="مثال: شرح مستر حماده أكتر من رائع!..." required>{{ $review['text'] ?? '' }}</textarea>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">اسم الطالب</label>
                            <input type="text" name="about_reviews[{{ $index }}][student_name]" 
                                   class="form-control" value="{{ $review['student_name'] ?? '' }}" 
                                   placeholder="مثال: أحمد محمد" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">الصف</label>
                            <input type="text" name="about_reviews[{{ $index }}][grade]" 
                                   class="form-control" value="{{ $review['grade'] ?? '' }}" 
                                   placeholder="مثال: الصف الثالث الثانوي" required>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">الحرف الأول</label>
                            <input type="text" name="about_reviews[{{ $index }}][initial]" 
                                   class="form-control" value="{{ $review['initial'] ?? '' }}" 
            ...
            <div id="about-achievements-container">
                ...
                @endphp
                @foreach($achievementsData as $index => $ach)
                <div class="about-achievement-item mb-3 p-3 border rounded">
                    <div class="row g-3 align-items-center">
                        <div class="col-md-3 text-center">
                            @php $imgPath = $ach['image'] ?? ''; @endphp
                            @if($imgPath)
                                <img src="{{ asset($imgPath) }}" alt="achievement" style="max-height:100px; border-radius:8px;">
                            @else
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="about_achievements[{{ $index }}][caption]" class="form-control" value="{{ $ach['caption'] ?? '' }}" placeholder="مثال: فاز بجائزة أفضل مدرس 2023">
                            <input type="hidden" name="about_achievements[{{ $index }}][existing_image]" value="{{ $ach['image'] ?? '' }}">
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">صورة (اختياري)</label>
                            <input type="file" name="about_achievements_images[{{ $index }}]" class="form-control" accept="image/*">
                        </div>
                        <div class="col-md-1 d-flex align-items-end">
        ...
        <div class="card-body-modern">
            <div class="mb-3">
                ...
                <textarea class="form-control" id="footer_text" name="footer_text" rows="3" 
                          placeholder="منصة تعليمية متخصصة في مادة الأحياء...">{{ $settings['footer_text'] ?? '' }}</textarea>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="footer_copyright" name="footer_copyright" 
                       value="{{ $settings['footer_copyright'] ?? '' }}" placeholder="جميع الحقوق محفوظة © {{ date('Y') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="developer_text" name="developer_text" 
                       value="{{ $settings['developer_text'] ?? 'برمجة وتطوير بواسطة' }}" placeholder="برمجة وتطوير بواسطة">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="url" class="form-control" id="developer_facebook" name="developer_facebook" 
                           value="{{ $settings['developer_facebook'] ?? '' }}" placeholder="https://facebook.com/...">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="developer_whatsapp" name="developer_whatsapp" 
                           value="{{ $settings['developer_whatsapp'] ?? '' }}" placeholder="01234567890">
    ...
    <div class="modern-card mb-4">
        ...
        <div class="card-body-modern">
            <div class="row">
                <div class="col-md-6">
                    <div class="preview-box" style="background: linear-gradient(135deg, {{ $settings['primary_color'] ?? '#7424a9' }}, {{ $settings['secondary_color'] ?? '#fa896b' }}); padding: 30px; border-radius: 15px; color: white; text-align: center;">
                        <h3 style="color: white; margin-bottom: 10px;">{{ $settings['site_name'] ?? 'اسم المنصة' }}</h3>
                        <p style="color: white; margin: 0;">{{ $settings['teacher_name'] ?? 'اسم المدرس' }} - {{ $settings['subject_name'] ?? 'المادة' }}</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="preview-box" style="border: 2px solid {{ $settings['primary_color'] ?? '#7424a9' }}; padding: 30px; border-radius: 15px;">
                        <h4 style="color: {{ $settings['primary_color'] ?? '#7424a9' }};">عنوان باللون الأساسي</h4>
                        <p style="color: {{ $settings['secondary_color'] ?? '#fa896b' }};">نص باللون الثانوي</p>
                        <button type="button" class="btn" style="background: {{ $settings['primary_color'] ?? '#7424a9' }}; color: white; border-radius: 10px; padding: 10px 20px;">
                            زر تجريبي
                        </button>
                    </div>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="d-flex align-items-center mb-2">
                        <input type="checkbox" name="stat_experience_enabled" id="stat_experience_enabled" 
                               {{ isset($settings['hero_stats'][0]['enabled']) && $settings['hero_stats'][0]['enabled'] ? 'checked' : '' }} class="me-2">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <input type="text" name="stat_experience" class="form-control" 
                                   value="{{ $settings['hero_stats'][0]['number'] ?? '15' }}" placeholder="15">
                        </div>
                        <div class="col-4">
                            <input type="text" name="stat_experience_label" class="form-control" 
                                   value="{{ $settings['hero_stats'][0]['label'] ?? 'سنة خبرة' }}" placeholder="سنة خبرة">
                        </div>
                        <div class="col-4">
                            <input type="text" name="stat_experience_icon" class="form-control" 
                                   value="{{ $settings['hero_stats'][0]['icon'] ?? 'fa-calendar-check' }}" placeholder="fa-calendar-check">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="d-flex align-items-center mb-2">
                        <input type="checkbox" name="stat_success_rate_enabled" id="stat_success_rate_enabled" 
                               {{ isset($settings['hero_stats'][1]['enabled']) && $settings['hero_stats'][1]['enabled'] ? 'checked' : '' }} class="me-2">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <input type="text" name="stat_success_rate" class="form-control" 
                                   value="{{ $settings['hero_stats'][1]['number'] ?? '95' }}" placeholder="95">
                        </div>
                        <div class="col-4">
                            <input type="text" name="stat_success_rate_label" class="form-control" 
                                   value="{{ $settings['hero_stats'][1]['label'] ?? 'نسبة النجاح %' }}" placeholder="نسبة النجاح %">
                        </div>
                        <div class="col-4">
                            <input type="text" name="stat_success_rate_icon" class="form-control" 
                                   value="{{ $settings['hero_stats'][1]['icon'] ?? 'fa-trophy' }}" placeholder="fa-trophy">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="d-flex align-items-center mb-2">
                        <input type="checkbox" name="stat_students_enabled" id="stat_students_enabled" 
                               {{ isset($settings['hero_stats'][2]['enabled']) && $settings['hero_stats'][2]['enabled'] ? 'checked' : '' }} class="me-2">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <input type="text" name="stat_students" class="form-control" 
                                   value="{{ $settings['hero_stats'][2]['number'] ?? '5000' }}" placeholder="5000">
                        </div>
                        <div class="col-4">
                            <input type="text" name="stat_students_label" class="form-control" 
                                   value="{{ $settings['hero_stats'][2]['label'] ?? 'طالب' }}" placeholder="طالب">
                        </div>
                        <div class="col-4">
                            <input type="text" name="stat_students_icon" class="form-control" 
                                   value="{{ $settings['hero_stats'][2]['icon'] ?? 'fa-users' }}" placeholder="fa-users">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="d-flex align-items-center mb-2">
                        <input type="checkbox" name="stat_rating_enabled" id="stat_rating_enabled" 
                               {{ isset($settings['hero_stats'][3]['enabled']) && $settings['hero_stats'][3]['enabled'] ? 'checked' : '' }} class="me-2">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <input type="text" name="stat_rating" class="form-control" 
                                   value="{{ $settings['hero_stats'][3]['number'] ?? '4.9' }}" placeholder="4.9">
                        </div>
                        <div class="col-4">
                            <input type="text" name="stat_rating_label" class="form-control" 
                                   value="{{ $settings['hero_stats'][3]['label'] ?? 'تقييم' }}" placeholder="تقييم">
                        </div>
                        <div class="col-4">
                            <input type="text" name="stat_rating_icon" class="form-control" 
                                   value="{{ $settings['hero_stats'][3]['icon'] ?? 'fa-star' }}" placeholder="fa-star">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card-body-modern">
            ...
            <div class="alert alert-info mb-3">
                ...
                <ul class="mb-0 mt-2">
                    ...
                    <li>
                        <strong>{{ $feat['title'] ?? 'بدون عنوان' }}</strong>
                        @if(isset($feat['description']) && !empty($feat['description']))
                        - {{ Str::limit($feat['description'], 50) }}
                        @endif
                        <span class="badge bg-{{ isset($feat['enabled']) && $feat['enabled'] ? 'success' : 'secondary' }} ms-2">
                            {{ isset($feat['enabled']) && $feat['enabled'] ? 'مفعّل' : 'معطّل' }}
                        </span>
                    </li>
                    @endforeach
                </ul>
                ...
                <div class="feature-item mb-3 p-3 border rounded">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div class="form-check">
                            <input type="checkbox" name="features[{{ $index }}][enabled]" class="form-check-input" 
                                   {{ isset($feature['enabled']) && $feature['enabled'] ? 'checked' : 'checked' }} id="feature_enabled_{{ $index }}">
                            <label class="form-check-label" for="feature_enabled_{{ $index }}">مفعّل</label>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-2">
                            <input type="text" name="features[{{ $index }}][title]" class="form-control" 
                                   value="{{ $feature['title'] ?? '' }}" placeholder="العنوان" required>
                        </div>
                        <div class="col-md-4 mb-2">
                            <input type="text" name="features[{{ $index }}][icon]" class="form-control" 
                                   value="{{ $feature['icon'] ?? 'fa-check' }}" placeholder="fa-video">
                        </div>
                        <div class="col-md-12 mb-2">
                            <textarea name="features[{{ $index }}][description]" class="form-control" rows="2" 
                                      placeholder="الوصف">{{ $feature['description'] ?? '' }}</textarea>
                        </div>
                    </div>
                </div>
                @endforeach
    ...
    <div class="modern-card mb-4">
        ...
        <div class="card-body-modern">
            ...
            @endphp
            @if(count($currentConcepts) > 0)
            <div class="alert alert-info mb-3">
                <strong><i class="fas fa-info-circle me-2"></i>القيم الحالية:</strong>
                <ul class="mb-0 mt-2">
                    @foreach($currentConcepts as $concept)
                    <li>
                        <i class="fas {{ $concept['icon'] ?? 'fa-circle' }} me-2"></i>
                        <strong>{{ $concept['name'] ?? 'بدون اسم' }}</strong>
                        <span class="badge bg-{{ isset($concept['enabled']) && $concept['enabled'] ? 'success' : 'secondary' }} ms-2">
                            {{ isset($concept['enabled']) && $concept['enabled'] ? 'مفعّل' : 'معطّل' }}
                        </span>
                    </li>
                    @endforeach
                </ul>
            ...
            <div id="concepts-container">
                ...
                <div class="concept-item mb-3 p-3 border rounded">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div class="form-check">
                            <input type="checkbox" name="concepts[{{ $index }}][enabled]" class="form-check-input" 
                                   {{ isset($concept['enabled']) && $concept['enabled'] ? 'checked' : 'checked' }} id="concept_enabled_{{ $index }}">
                            <label class="form-check-label" for="concept_enabled_{{ $index }}">مفعّل</label>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="text" name="concepts[{{ $index }}][name]" class="form-control" 
                                   value="{{ $concept['name'] ?? '' }}" placeholder="مثال: الضوء" required>
                        </div>
                        <div class="col-md-6 mb-2">
                            <label class="form-label">الأيقونة (Font Awesome)</label>
                            <input type="text" name="concepts[{{ $index }}][icon]" class="form-control" 
                                   value="{{ $concept['icon'] ?? 'fa-circle' }}" placeholder="fa-lightbulb">
    ...
    <div class="modern-card mb-4">
        ...
        <div class="card-body-modern">
            ...
            @endphp
            @if(count($currentTopics) > 0)
            <div class="alert alert-info mb-3">
                <strong><i class="fas fa-info-circle me-2"></i>القيم الحالية:</strong>
                <ul class="mb-0 mt-2">
                    @foreach($currentTopics as $topic)
                    <li>
                        <strong>{{ $topic['name'] ?? 'بدون اسم' }}</strong>
                        <span class="badge bg-{{ isset($topic['enabled']) && $topic['enabled'] ? 'success' : 'secondary' }} ms-2">
                            {{ isset($topic['enabled']) && $topic['enabled'] ? 'مفعّل' : 'معطّل' }}
                        </span>
                    </li>
                    @endforeach
                </ul>
            ...
            <div id="topics-container">
                ...
                <div class="topic-item mb-3 p-3 border rounded">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div class="form-check">
                            <input type="checkbox" name="topics[{{ $index }}][enabled]" class="form-check-input" 
                                   {{ isset($topic['enabled']) && $topic['enabled'] ? 'checked' : 'checked' }} id="topic_enabled_{{ $index }}">
                            <label class="form-check-label" for="topic_enabled_{{ $index }}">مفعّل</label>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <input type="text" name="topics[{{ $index }}][name]" class="form-control" 
                                   value="{{ $topic['name'] ?? '' }}" placeholder="اسم الموضوع" required>
                        </div>
                        <div class="col-md-6 mb-2">
                            <input type="text" name="topics[{{ $index }}][icon]" class="form-control" 
                                   value="{{ $topic['icon'] ?? 'fa-atom' }}" placeholder="fa-atom">
                        </div>
                    </div>
                </div>
                @endforeach
        ...
        <div class="card-body-modern">
            ...
            <div class="alert alert-info mb-3">
                ...
                <ul class="mb-0 mt-2">
                    ...
                    <li>
                        <strong>{{ $grade['name'] ?? 'بدون اسم' }}</strong>
                        <span class="badge bg-{{ isset($grade['enabled']) && $grade['enabled'] ? 'success' : 'secondary' }} ms-2">
                            {{ isset($grade['enabled']) && $grade['enabled'] ? 'مفعّل' : 'معطّل' }}
                        </span>
                    </li>
                    @endforeach
                </ul>
            ...
            <div id="grades-container">
                ...
                <div class="grade-item mb-3 p-3 border rounded">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div class="form-check">
                            <input type="checkbox" name="grades[{{ $index }}][enabled]" class="form-check-input" 
                                   {{ isset($grade['enabled']) && $grade['enabled'] ? 'checked' : 'checked' }} id="grade_enabled_{{ $index }}">
                            <label class="form-check-label" for="grade_enabled_{{ $index }}">مفعّل</label>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <input type="text" name="grades[{{ $index }}][name]" class="form-control" 
                                   value="{{ $grade['name'] ?? '' }}" placeholder="اسم السنة الدراسية" required>
                        </div>
                        <div class="col-md-6 mb-2">
                            <input type="text" name="grades[{{ $index }}][icon]" class="form-control" 
                                   value="{{ $grade['icon'] ?? 'fa-graduation-cap' }}" placeholder="fa-graduation-cap">
                        </div>
                    </div>
                </div>
                @endforeach
    ...
    <div class="modern-card mb-4">
        ...
        <div class="card-body-modern">
            ...
            @endphp
            @if(count($currentBenefits) > 0)
            <div class="alert alert-info mb-3">
                <strong><i class="fas fa-info-circle me-2"></i>القيم الحالية ({{ count($currentBenefits) }} مميزة):</strong>
                <ul class="mb-0 mt-2">
                    @foreach($currentBenefits as $benefit)
                    <li>
                        <strong>{{ $benefit['title'] ?? 'بدون عنوان' }}</strong>
                        @if(isset($benefit['description']) && !empty($benefit['description']))
                        - {{ Str::limit($benefit['description'], 50) }}
                        @endif
                        <span class="badge bg-{{ isset($benefit['enabled']) && $benefit['enabled'] ? 'success' : 'secondary' }} ms-2">
                            {{ isset($benefit['enabled']) && $benefit['enabled'] ? 'مفعّل' : 'معطّل' }}
                        </span>
                    </li>
                    @endforeach
                </ul>
            ...
            <div id="benefits-container">
                ...
                <div class="benefit-item mb-3 p-3 border rounded">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div class="form-check">
                            <input type="checkbox" name="benefits[{{ $index }}][enabled]" class="form-check-input" 
                                   {{ isset($benefit['enabled']) && $benefit['enabled'] ? 'checked' : 'checked' }} id="benefit_enabled_{{ $index }}">
                            <label class="form-check-label" for="benefit_enabled_{{ $index }}">مفعّل</label>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-2">
                            <input type="text" name="benefits[{{ $index }}][title]" class="form-control" 
                                   value="{{ $benefit['title'] ?? '' }}" placeholder="العنوان" required>
                        </div>
                        <div class="col-md-4 mb-2">
                            <input type="text" name="benefits[{{ $index }}][icon]" class="form-control" 
                                   value="{{ $benefit['icon'] ?? 'fa-check' }}" placeholder="fa-book-open">
                        </div>
                        <div class="col-md-12 mb-2">
                            <textarea name="benefits[{{ $index }}][description]" class="form-control" rows="2" 
                                      placeholder="الوصف">{{ $benefit['description'] ?? '' }}</textarea>
                        </div>
                    </div>
                </div>
                @endforeach
    ...
    <div class="modern-card mb-4">
        ...
        <div class="card-body-modern">
            ...
            @endphp
            @if(count($currentSignupGrades) > 0)
            <div class="alert alert-info mb-3">
                <strong><i class="fas fa-info-circle me-2"></i>القيم الحالية:</strong>
                <ul class="mb-0 mt-2">
                    @foreach($currentSignupGrades as $grade)
                    <li>
                        <strong>{{ $grade['label'] ?? 'بدون تسمية' }}</strong> 
                        <span class="text-muted">({{ $grade['value'] ?? 'بدون قيمة' }})</span>
                        <span class="badge bg-{{ isset($grade['enabled']) && $grade['enabled'] ? 'success' : 'secondary' }} ms-2">
                            {{ isset($grade['enabled']) && $grade['enabled'] ? 'مفعّل' : 'معطّل' }}
                        </span>
                    </li>
            ...
            <div id="signup-grades-container">
                ...
                <div class="signup-grade-item mb-3 p-3 border rounded">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div class="form-check">
                            <input type="checkbox" name="signup_grades[{{ $index }}][enabled]" class="form-check-input" 
                                   {{ isset($grade['enabled']) && $grade['enabled'] ? 'checked' : 'checked' }} id="signup_grade_enabled_{{ $index }}">
                            <label class="form-check-label" for="signup_grade_enabled_{{ $index }}">مفعّل</label>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <input type="text" name="signup_grades[{{ $index }}][value]" class="form-control" 
                                   value="{{ $grade['value'] ?? '' }}" placeholder="القيمة (أولي، تانية، إلخ)" required>
                        </div>
                        <div class="col-md-6 mb-2">
                            <input type="text" name="signup_grades[{{ $index }}][label]" class="form-control" 
                                   value="{{ $grade['label'] ?? '' }}" placeholder="التسمية (الصف الأول الثانوي)" required>
                        </div>
                    </div>
                </div>
                @endforeach
    ...
    <div class="modern-card mb-4">
        ...
        <div class="card-body-modern">
            ...
            @if(!empty($currentPaymentMethods))
            <div class="alert alert-info mb-3">
                <strong><i class="fas fa-info-circle me-2"></i>الإعدادات الحالية:</strong>
                <ul class="mb-0 mt-2">
                    <li>
                        <strong>الدفع الأونلاين:</strong> 
                        <span class="badge bg-{{ $currentPaymentMethods['online_payment'] ?? false ? 'success' : 'secondary' }}">
                            {{ $currentPaymentMethods['online_payment'] ?? false ? 'مفعّل' : 'معطّل' }}
                        </span>
                    </li>
                    <li>
                        <strong>أكواد التفعيل:</strong> 
                        <span class="badge bg-{{ $currentPaymentMethods['activation_codes'] ?? false ? 'success' : 'secondary' }}">
                            {{ $currentPaymentMethods['activation_codes'] ?? false ? 'مفعّل' : 'معطّل' }}
                        </span>
                    </li>
                    <li>
                        <strong>تفعيل من الأدمن:</strong> 
                        <span class="badge bg-{{ $currentPaymentMethods['admin_activation'] ?? false ? 'success' : 'secondary' }}">
                            {{ $currentPaymentMethods['admin_activation'] ?? false ? 'مفعّل' : 'معطّل' }}
                        </span>
                    </li>
                    <li>
                        <strong>الكورسات المجانية:</strong> 
                        <span class="badge bg-{{ $currentPaymentMethods['free_courses'] ?? false ? 'success' : 'secondary' }}">
                            {{ $currentPaymentMethods['free_courses'] ?? false ? 'مفعّل' : 'معطّل' }}
                        </span>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="payment_methods[online_payment]" 
                               ...
                               {{ ($currentPaymentMethods['online_payment'] ?? true) ? 'checked' : '' }}>
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="payment_methods[activation_codes]" 
                               ...
                               {{ ($currentPaymentMethods['activation_codes'] ?? true) ? 'checked' : '' }}>
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="payment_methods[admin_activation]" 
                               ...
                               {{ ($currentPaymentMethods['admin_activation'] ?? true) ? 'checked' : '' }}>
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="payment_methods[free_courses]" 
                               ...
                               {{ ($currentPaymentMethods['free_courses'] ?? true) ? 'checked' : '' }}>
    ...
    <div class="modern-card mb-4">
        ...
        <div class="card-body-modern">
            ...
            @endphp
            @if(count($currentGovernorates) > 0)
            <div class="alert alert-info mb-3">
                <strong><i class="fas fa-info-circle me-2"></i>القيم الحالية:</strong>
                <div class="mt-2">
                    @foreach($currentGovernorates as $gov)
                    <span class="badge bg-{{ isset($gov['enabled']) && $gov['enabled'] ? 'success' : 'secondary' }} me-2 mb-2" style="font-size: 14px; padding: 8px 12px;">
                        {{ $gov['name'] ?? 'بدون اسم' }}
                        <i class="fas fa-{{ isset($gov['enabled']) && $gov['enabled'] ? 'check' : 'times' }} ms-1"></i>
                    </span>
                    @endforeach
                </div>
            </div>
            ...
            <div id="governorates-container">
                ...
                <div class="governorate-item mb-2 p-2 border rounded d-flex justify-content-between align-items-center">
                    <div class="form-check">
                        <input type="checkbox" name="governorates[{{ $index }}][enabled]" class="form-check-input" 
                               {{ isset($gov['enabled']) && $gov['enabled'] ? 'checked' : 'checked' }} id="gov_enabled_{{ $index }}">
                        <input type="text" name="governorates[{{ $index }}][name]" class="form-control d-inline-block ms-2" 
                               value="{{ $gov['name'] ?? '' }}" placeholder="اسم المحافظة" style="width: 200px;" required>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="faq_title" class="form-control" 
                           value="{{ $settings['faq_title'] ?? 'هل لديك سؤال؟' }}" 
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="faq_subtitle" class="form-control" 
                           value="{{ $settings['faq_subtitle'] ?? 'إجابات على الأسئلة الأكثر شيوعاً' }}" 
                    ...
                    <div id="faq-list-container">
                        ...
                        <div class="faq-item-settings mb-3 p-3 border rounded">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <strong class="text-primary">سؤال {{ $index + 1 }}</strong>
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="faq_list[{{ $index }}][question]" 
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="faq_list[{{ $index }}][answer]" 
                                              ...
                                              placeholder="مثال: يمكنك الاشتراك بسهولة عن طريق..." required>{{ $faq['answer'] ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                        @endforeach
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="signup_card_title" class="form-control" 
                           value="{{ $settings['signup_card_title'] ?? 'انضم إلينا اليوم!' }}" 
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="signup_card_subtitle" class="form-control" 
                           value="{{ $settings['signup_card_subtitle'] ?? 'ابدأ رحلتك نحو نهائية الاحياء' }}" 
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <input type="text" name="signup_card_teacher_name" class="form-control" 
                           value="{{ $settings['signup_card_teacher_name'] ?? 'مع مستر سامح صلاح' }}" 
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <div id="signup-benefits-container">
                        ...
                        @endphp
                        @foreach($signupBenefits as $index => $benefit)
                        <div class="signup-benefit-item mb-3 p-3 border rounded">
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <label class="form-label">العنوان</label>
                                    <input type="text" name="signup_benefits[{{ $index }}][title]" 
                                           class="form-control" value="{{ $benefit['title'] ?? '' }}" 
                                           placeholder="مثال: شرح مبسط وواضح" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">الوصف</label>
                                    <input type="text" name="signup_benefits[{{ $index }}][description]" 
                                           class="form-control" value="{{ $benefit['description'] ?? '' }}" 
                                           placeholder="مثال: لجميع النقاط" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">الأيقونة</label>
                                    <input type="text" name="signup_benefits[{{ $index }}][icon]" 
                                           class="form-control" value="{{ $benefit['icon'] ?? 'fa-check-circle' }}" 
        ...
        <div class="card-body-modern">
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <textarea name="privacy_policy" class="form-control" rows="10" placeholder="أدخل نص سياسة الخصوصية...">{{ $settings['privacy_policy'] ?? '' }}</textarea>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">شروط الاستخدام</label>
                    <textarea name="terms_of_service" class="form-control" rows="10" placeholder="أدخل نص شروط الاستخدام...">{{ $settings['terms_of_service'] ?? '' }}</textarea>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="session_lifetime" class="form-control" 
                           value="{{ $settings['session_lifetime'] ?? 0 }}" min="0" max="525600">
                    <small class="text-muted">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" name="login_attempts" class="form-control" 
                           value="{{ $settings['login_attempts'] ?? 5 }}" min="3" max="10">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="form-check form-switch mt-3">
                        <input class="form-check-input" type="checkbox" name="login_enabled" 
                               ...
                               {{ ($settings['login_enabled'] ?? true) ? 'checked' : '' }}>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="color" name="text_color" class="form-control form-control-color" 
                           value="{{ $settings['text_color'] ?? '#333333' }}" title="اختر لون النصوص">
                </div>
                <div class="col-md-4 mb-3">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <select name="heading_font" class="form-select">
                        <option value="Tajawal" {{ ($settings['heading_font'] ?? 'Tajawal') == 'Tajawal' ? 'selected' : '' }}>Tajawal</option>
                        <option value="Cairo" {{ ($settings['heading_font'] ?? '') == 'Cairo' ? 'selected' : '' }}>Cairo</option>
                        <option value="Almarai" {{ ($settings['heading_font'] ?? '') == 'Almarai' ? 'selected' : '' }}>Almarai</option>
                        <option value="Amiri" {{ ($settings['heading_font'] ?? '') == 'Amiri' ? 'selected' : '' }}>Amiri</option>
                        <option value="Arial" {{ ($settings['heading_font'] ?? '') == 'Arial' ? 'selected' : '' }}>Arial</option>
                    </select>
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label">خط النص</label>
                    <select name="body_font" class="form-select">
                        <option value="Tajawal" {{ ($settings['body_font'] ?? 'Tajawal') == 'Tajawal' ? 'selected' : '' }}>Tajawal</option>
                        <option value="Cairo" {{ ($settings['body_font'] ?? '') == 'Cairo' ? 'selected' : '' }}>Cairo</option>
                        <option value="Almarai" {{ ($settings['body_font'] ?? '') == 'Almarai' ? 'selected' : '' }}>Almarai</option>
                        <option value="Amiri" {{ ($settings['body_font'] ?? '') == 'Amiri' ? 'selected' : '' }}>Amiri</option>
                        <option value="Arial" {{ ($settings['body_font'] ?? '') == 'Arial' ? 'selected' : '' }}>Arial</option>
                    </select>
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label">حجم الخط الأساسي (px)</label>
                    <input type="number" name="font_size" class="form-control" 
                           value="{{ $settings['font_size'] ?? 16 }}" min="12" max="24">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body-modern">
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    @if(isset($settings['default_course_image']) && !empty($settings['default_course_image']))
                    <small class="text-muted">الصورة الحالية: {{ $settings['default_course_image'] }}</small>
                    @endif
                </div>
                <div class="col-md-4 mb-3">
                    ...
                    @if(isset($settings['default_student_image']) && !empty($settings['default_student_image']))
                    <small class="text-muted">الصورة الحالية: {{ $settings['default_student_image'] }}</small>
                    @endif
                </div>
                <div class="col-md-4 mb-3">
                    ...
                    <small class="text-muted">الصورة الحالية: {{ $settings['hero_image'] }}</small>
                    @endif
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="url" name="telegram_url" class="form-control" 
                           value="{{ $settings['telegram_url'] ?? '' }}" placeholder="https://t.me/...">
                </div>
                <div class="col-md-12 mb-3">
                    <label class="form-label">روابط أخرى (JSON)</label>
                    <textarea name="other_links" class="form-control" rows="5" 
                              placeholder='{"link_name": "https://example.com", ...}'>{{ $settings['other_links'] ?? '' }}</textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" 
                                           value="{{ url('/webhook/payment') }}" readonly>
                                    <button type="button" class="btn btn-outline-secondary" onclick="copyToClipboard('{{ url('/webhook/payment') }}')">
                    ...
                    <div class="card border-primary">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" 
                                           value="{{ url('/webhook/register-student') }}" readonly>
                                    <button type="button" class="btn btn-outline-secondary" onclick="copyToClipboard('{{ url('/webhook/register-student') }}')">
                                        <i class="fas fa-copy"></i> نسخ
                                    </button>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" 
                                           value="{{ url('/webhook/activate-subscription') }}" readonly>
                                    <button type="button" class="btn btn-outline-secondary" onclick="copyToClipboard('{{ url('/webhook/activate-subscription') }}')">
                                        <i class="fas fa-copy"></i> نسخ
                                    </button>
                                </div>
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <textarea name="hero_additional_text" class="form-control" rows="3" 
                              placeholder="نص إضافي يظهر في Hero Section...">{{ $settings['hero_additional_text'] ?? '' }}</textarea>
                </div>
                <div class="col-md-6 mb-3">
                    <label class="form-label">رابط Call-to-Action الأول</label>
                    <input type="url" name="cta_link_1" class="form-control" 
                           value="{{ $settings['cta_link_1'] ?? '' }}" placeholder="https://...">
                    <input type="text" name="cta_text_1" class="form-control mt-2" 
                           value="{{ $settings['cta_text_1'] ?? 'اشترك الآن' }}" placeholder="نص الزر">
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="cta_text_2" class="form-control mt-2" 
                           value="{{ $settings['cta_text_2'] ?? 'تعرف على المزيد' }}" placeholder="نص الزر">
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="courses_per_page" class="form-control" 
                           value="{{ $settings['courses_per_page'] ?? 12 }}" min="6" max="24">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('admin.general_settings.reset') }}" method="POST" style="display: inline;">
                    @csrf
                    @method('POST')
...
let conceptIndex = {{ count($settings['subject_concepts'] ?? []) }};
function addConcept() {
...
let featureIndex = {{ count($settings['features_list'] ?? []) }};
function addFeature() {
...
let topicIndex = {{ count($settings['topics_list'] ?? []) }};
function addTopic() {
...
let gradeIndex = {{ count($settings['grades_list'] ?? []) }};
function addGrade() {
...
let benefitIndex = {{ count($settings['benefits_list'] ?? []) }};
function addBenefit() {
...
let achievementIndex = {{ count($settings['about_teacher_achievements'] ?? []) }};
...
let signupGradeIndex = {{ count($settings['signup_grades'] ?? []) }};
...
@endphp
let signupBenefitIndex = {{ count($signupBenefitsForCount) }};
...
@endphp
let faqIndex = {{ count($faqListForJS) }};
function addFAQItem() {
...
let governorateIndex = {{ count($settings['governorates_list'] ?? []) }};
...
@endphp
let aboutQualificationIndex = {{ count($qualificationsForJS) }};
...
@endphp
let aboutStatIndex = {{ count($statsForJS) }};
...
@endphp
let aboutMethodIndex = {{ count($methodsForJS) }};
...
@endphp
let aboutReviewIndex = {{ count($reviewsForJS) }};
