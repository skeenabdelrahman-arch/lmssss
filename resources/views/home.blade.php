        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col">
                    ...
                    <p class="text-muted mb-0 font-weight-medium">إليك ما يحدث في منصتك اليوم، {{ date('l, d M Y') }}</p>
                </div>
                <div class="col-auto">
                </div>
            </div>
...
@section('content')
    <div class="container-fluid">
        <div class="row g-4">
            <div class="col-xl-3 col-lg-6">
                <div class="card smart-card p-4">
                    ...
                    <div class="stat-val text-indigo">{{ $students }}</div>
                    <div class="stat-lab mb-4">إجمالي الطلاب المسجلين</div>
                    <div class="d-flex gap-2">
                        <a href="{{url('students-all')}}" class="btn btn-pill bg-primary text-white w-100 shadow-sm">
            ...
            <div class="col-xl-3 col-lg-6">
                <div class="card smart-card p-4">
                    ...
                    <div class="stat-val">{{ $taken_exams }}</div>
                    <div class="stat-lab mb-4">اختبارات تم إكمالها</div>
                    <a href="{{url('show-taken-exams')}}" class="btn btn-pill bg-light text-dark w-100 border">
            ...
            <div class="col-xl-3 col-lg-6">
                <div class="card smart-card p-4">
                    ...
                    <div class="stat-val">{{ $public_exams }}</div>
                    <div class="stat-lab mb-4">الامتحانات العامة المتاحة</div>
                    <a href="{{route('publicExam.results')}}" class="btn btn-pill bg-info text-white w-100 shadow-sm">
                        إدارة الامتحانات
                    </a>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-6">
                <div class="card smart-card p-4">
                    ...
                    <div class="stat-val">{{ $lectures }}</div>
                    <div class="stat-lab mb-4">محاضرات تعليمية</div>
                    <a href="{{route('lecture.index')}}" class="btn btn-pill bg-success text-white w-100 shadow-sm">
                        إدارة المحتوى
                    </a>
                </div>
            </div>
        ...
        @if(isset($public_exams_list) && $public_exams_list->count() > 0)
            <div class="row mt-5 pt-4">
                <div class="col-12 d-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="{{ route('publicExam.results') }}" class="btn btn-link text-decoration-none fw-bold">عرض الكل</a>
                </div>

                @foreach($public_exams_list as $exam)
                    <div class="col-xl-4 col-md-6 mb-4">
                        <div class="exam-glass-card h-100 d-flex flex-column shadow-sm">
                            <div class="d-flex align-items-center mb-3">
                                <div class="flex-grow-1">
                                    <h6 class="fw-bold mb-1">{{ $exam->exam_title }}</h6>
                                    <span class="text-muted x-small" style="font-size: 12px;">
                                        <i class="far fa-clock me-1"></i> المدة: {{ $exam->exam_time }} دقيقة
                                    </span>
                                </div>
                                <div class="ms-2">
                            ...
                            <p class="text-muted small flex-grow-1">
                                {{ Str::limit($exam->exam_description, 90) }}
                            </p>
                            ...
                            <div class="mt-3 pt-3 border-top d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('publicExam.take', $exam->id) }}"
