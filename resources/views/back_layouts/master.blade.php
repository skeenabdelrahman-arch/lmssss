...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('css/admin-enhancements.css') }}" onerror="console.error('Failed to load admin-enhancements.css')">
...
<body>
    ...
    <div class="main-header">
        ...
        <div class="user-menu">
            ...
            <div class="notification-menu" style="position: relative; margin-left: 20px;">
                ...
                <ul class="dropdown-menu dropdown-menu-end notification-dropdown" aria-labelledby="notificationsDropdown" style="width: 350px; max-height: 400px; overflow-y: auto; margin-top: 10px;">
                    ...
                    @if($latestNotifications->count() > 0)
                        ...
                        <li>
                            <a class="dropdown-item notification-item {{ !$notification->is_read ? 'unread' : '' }}" href="{{ $notification->url ?? route('admin.notifications.index') }}">
            ...
            <div class="user-info">
                ...
                <span>{{ Auth::guard('web')->user()->name ?? 'Admin' }}</span>
            </div>
            <a href="{{ route('logoutAdmin') }}" class="logout-btn" onclick="return confirm('هل أنت متأكد من تسجيل الخروج؟')">
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="menu-section">
            ...
            <a href="{{ route('admin.student.create') }}" class="{{ request()->is('admin/add-student') || request()->is('admin/create-student') ? 'active' : '' }}">
                <i class="fas fa-user-plus"></i>
                <span>إضافة طالب</span>
            </a>
            <a href="{{ route('students.all') }}" class="{{ request()->is('students-all*') ? 'active' : '' }}">
                <i class="fas fa-users"></i>
                <span>جميع الطلاب</span>
            </a>
            <a href="{{ route('admin.excel.import.students') }}" class="{{ request()->is('admin/excel/import/students*') ? 'active' : '' }}">
                <i class="fas fa-file-excel"></i>
                <span>استيراد الطلاب من Excel</span>
            </a>
            <a href="{{ route('admin.excel.import.subscriptions') }}" class="{{ request()->is('admin/excel/import/subscriptions*') ? 'active' : '' }}">
                <i class="fas fa-file-upload"></i>
                <span>استيراد الاشتراكات من Excel</span>
            </a>
            <a href="{{ route('admin.excel.deactivate.subscriptions') }}" class="{{ request()->is('admin/excel/deactivate/subscriptions*') ? 'active' : '' }}">
                <i class="fas fa-user-times"></i>
                <span>إلغاء تفعيل الاشتراكات جماعياً</span>
            </a>
            <a href="{{ route('admin.excel.activated.students') }}" class="{{ request()->is('admin/excel/activated-students*') ? 'active' : '' }}">
        ...
        <div class="menu-section">
            ...
            <a href="{{ route('admin.general_settings.index') }}" class="{{ request()->is('admin/general-settings*') ? 'active' : '' }}">
        ...
        <div class="menu-section">
            ...
            <a href="{{ route('admin.blocked_students.index') }}" class="{{ request()->is('admin/blocked-students*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.payments.statistics') }}" class="{{ request()->is('admin/payments/statistics*') ? 'active' : '' }}">
                <i class="fas fa-chart-pie"></i>
                <span>إحصائيات المدفوعات</span>
            </a>
            <a href="{{ route('admin.kashier.index') }}" class="{{ request()->is('admin/kashier*') ? 'active' : '' }}">
        ...
        <div class="menu-section">
            ...
            <a href="{{ route('admin.analytics.dashboard') }}" class="{{ request()->is('admin/analytics/dashboard') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.analytics.student.performance') }}" class="{{ request()->is('admin/analytics/student-performance') ? 'active' : '' }}">
                <i class="fas fa-user-check"></i>
                <span>أداء الطلاب</span>
            </a>
            @if(is_payment_method_enabled('online_payment'))
            <a href="{{ route('admin.analytics.revenue') }}" class="{{ request()->is('admin/analytics/revenue') ? 'active' : '' }}">
                <i class="fas fa-dollar-sign"></i>
                <span>تقارير الإيرادات</span>
            </a>
            @endif
            <a href="{{ route('admin.analytics.content.usage') }}" class="{{ request()->is('admin/analytics/content-usage') ? 'active' : '' }}">
        ...
        <div class="menu-section">
            ...
            <a href="{{ route('admin.content.schedule.index') }}" class="{{ request()->is('admin/content/schedule*') ? 'active' : '' }}">
                <i class="fas fa-calendar-alt"></i>
        ...
        <div class="menu-section">
            ...
            <a href="{{ route('admin.discount_codes.index') }}" class="{{ request()->is('admin/discount-codes*') ? 'active' : '' }}">
                <i class="fas fa-tag"></i>
                <span>أكواد الخصم والحزم</span>
            </a>
            @if(is_payment_method_enabled('activation_codes'))
            <a href="{{ route('admin.activation_codes.index') }}" class="{{ request()->is('admin/activation-codes*') ? 'active' : '' }}">
                <i class="fas fa-key"></i>
                <span>أكواد التفعيل</span>
            </a>
            @endif
            <a href="{{ route('admin.lecture_restrictions.index') }}" class="{{ request()->is('admin/lecture-restrictions*') ? 'active' : '' }}">
                <i class="fas fa-ban"></i>
        ...
        <div class="menu-section">
            ...
            <a href="{{ route('admin.notifications.index') }}" class="{{ request()->is('admin/notifications*') ? 'active' : '' }}">
                ...
                @if($sidebarUnreadCount > 0)
                    <span class="badge bg-danger ms-2" style="font-size: 10px; padding: 2px 6px;">{{ $sidebarUnreadCount }}</span>
                @endif
            </a>
        </div>
    </div>
    ...
    <div class="main-footer">
        <p class="mb-0">جميع الحقوق محفوظة © {{ date('Y') }} - منصة مستر حماده مراد</p>
    </div>
    ...
    {{-- Cache Control Panel (Admin Only) --}}
    ...
    <div class="cache-control-panel" style="position: fixed; bottom: 20px; left: 20px; z-index: 9999; background: white; padding: 15px; border-radius: 10px; box-shadow: 0 5px 20px rgba(0,0,0,0.2); display: none;" id="cachePanel">
        ...
        <form action="{{ route('admin.cache.clear') }}" method="POST" style="margin-bottom: 10px;" onsubmit="return confirm('هل أنت متأكد من مسح جميع الـ Cache؟')">
            @csrf
