...
<div class="container-fluid p-0">
    <div class="modern-card">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="<?php echo e(route('admin.users.create')); ?>" class="btn btn-modern-primary shadow-sm">
            ...
            <table class="table modern-table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($user->role): ?>
                                <span class="badge-role badge-admin">
                                    <i class="fas fa-shield-alt me-1"></i> <?php echo e($user->role->name); ?>
                        ...
                        <td>
                            <span class="text-muted small"><i class="far fa-calendar-alt me-1"></i> <?php echo e($user->created_at->format('Y-m-d')); ?></span>
                        </td>
                        <td>
                            <div class="d-flex gap-2 justify-content-center">
                                
                                <a href="<?php echo e(route('admin.users.edit', $user->id)); ?>" class="btn-edit-modern" title="تعديل البيانات">
                                    <i class="fas fa-edit"></i>
                                </a>

                                
                                <?php if($user->id != Auth::guard('web')->id()): ?>
                                <form action="<?php echo e(route('admin.users.destroy', $user->id)); ?>" method="POST" onsubmit="return confirm('هل أنت متأكد من حذف هذا المستخدم نهائياً؟')">
                                    <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('back_layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\A-Tech\Downloads\archiveGzNa7\resources\views/back/admin/users/index.blade.php ENDPATH**/ ?>