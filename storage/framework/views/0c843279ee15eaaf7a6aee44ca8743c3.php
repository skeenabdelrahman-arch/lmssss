...
<?php echo e(site_name()); ?> | الصفحة الرئيسية
...
<style>
    :root {
        ...
        --primary-light: <?php echo e(primary_color()); ?>;
    }
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="hero-content">
                    <p class="quote"><?php echo e(hero_quote() ?: '" وما رميت إذ رميت ولكن الله رمى "'); ?></p>
                    <h1><?php echo e(hero_title() ?: (subject_name() . ' مع ' . teacher_name())); ?></h1>
                    <p class="subtitle"><?php echo e(hero_subtitle() ?: ('خبير تدريس مادة ' . subject_name())); ?></p>
                    ...
                    <p style="font-size: 1.2rem; color: #555; margin-top: 15px; white-space: pre-line; font-weight: 500;">
                        <?php echo e($extraText !== '' ? $extraText : 'أهلاً بك في منصتنا – كل الشرح والامتحانات في مكان واحد'); ?>
                    ...
                    <div class="hero-buttons">
                        <a href="<?php echo e($cta1Link); ?>" class="btn-hero primary" target="_blank" rel="noopener">
                            <i class="fas fa-arrow-right me-1"></i> <?php echo e($cta1Text); ?>

                        </a>

                        
                        <a href="<?php echo e(url('parent-portal')); ?>" class="btn-hero outline" target="_blank" rel="noopener" style="border-color: #667eea; color: #667eea;">
                            <i class="fas fa-user-shield me-1"></i> بوابة أولياء الأمور
                        </a>

                        <?php if($cta2Link !== ''): ?>
                        <a href="<?php echo e($cta2Link); ?>" class="btn-hero outline" target="_blank" rel="noopener">
                            <i class="fas fa-link me-1"></i> <?php echo e($cta2Text); ?>

                        </a>
                        <?php endif; ?>
                        <?php if($cta3Link !== ''): ?>
                        <a href="<?php echo e($cta3Link); ?>" class="btn-hero outline" target="_blank" rel="noopener">
                            <i class="fas fa-link me-1"></i> <?php echo e($cta3Text); ?>
                    ...
                    <div class="hero-stats">
                        <?php $__currentLoopData = hero_stats(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="stat-item">
                            <div class="stat-icon">
                                <i class="fas <?php echo e($stat['icon'] ?? 'fa-check'); ?>"></i>
                            </div>
                            <div class="stat-content">
                                <h3 class="stat-number" data-target="<?php echo e($stat['number'] ?? '0'); ?>">0</h3>
            ...
            <div class="col-lg-6">
                <div class="hero-image text-center">
                    ...
                    <img src="<?php echo e($heroImg); ?>" alt="<?php echo e(hero_title()); ?>" class="img-fluid hero-image-img">
                    <?php else: ?>
                    <!-- Cell Animation (Biology) -->
                    ...
                    <div class="physics-concepts">
                        ...
                        <div class="concept-item">
                            <i class="fas <?php echo e($concept['icon'] ?? 'fa-circle'); ?>"></i>
                            <span><?php echo e($concept['name'] ?? ''); ?></span>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <?php endif; ?>
...
<section class="features-section">
    <div class="container">
        <div class="section-title">
            ...
            <p>نوفر لك كل ما تحتاجه لتحقيق التفوق في مادة <?php echo e(subject_name()); ?></p>
        </div>
        <div class="row g-4">
            <?php $__currentLoopData = features_list(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3 col-md-6">
                <div class="feature-card">
                    <div class="feature-icon">
                        <i class="fas <?php echo e($feature['icon'] ?? 'fa-check'); ?>"></i>
                    </div>
        ...
        <?php if(count(topics_list()) > 0): ?>
        <div class="row g-4 mt-4">
            <?php $__currentLoopData = topics_list(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-2 col-md-4 col-6">
                <div class="feature-card">
                    <div class="feature-icon">
                        <i class="fas <?php echo e($topic['icon'] ?? 'fa-atom'); ?>"></i>
                    </div>
                    <h4><?php echo e($topic['name'] ?? ''); ?></h4>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="<?php echo e(route('studentLogin')); ?>" class="grade-card">
                    <div class="grade-image">
                        <i class="fas <?php echo e($grade['icon'] ?? 'fa-graduation-cap'); ?>"></i>
                    </div>
                    <div class="grade-content">
                        <h4><?php echo e($grade['name'] ?? ''); ?></h4>
                    </div>
                </a>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="container">
        ...
        <div class="text-center mt-5">
            <?php if(auth()->guard('student')->check()): ?>
                <a href="<?php echo e(route('courses.index')); ?>" class="btn-hero primary">
                    <i class="fas fa-graduation-cap me-2"></i> ابدأ التعلم الآن
                </a>
            <?php else: ?>
                <a href="<?php echo e(route('studentSignup')); ?>" class="btn-hero primary">
...
<section class="public-exams-section">
    <div class="container">
        ...
        <div class="row g-4">
            <?php $__currentLoopData = $publicExams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-4 col-md-6">
                <div class="exam-card">
                    <div class="exam-icon">
                        <i class="fas fa-clipboard-check"></i>
                    ...
                    <p style="color: #6c757d; font-size: 0.95rem; margin-bottom: 20px;">
                        <?php echo e(Str::limit($exam->exam_description, 80)); ?>

                    </p>
                    <?php endif; ?>
                    <span class="exam-badge">
                        <i class="fas fa-clock me-1"></i> <?php echo e($exam->exam_time); ?> دقيقة
                    </span>
                    <a href="<?php echo e(route('publicExam.take', $exam->id)); ?>" class="exam-btn">
        ...
        <?php if($publicExams->count() >= 6): ?>
        <div class="text-center mt-5">
            <a href="<?php echo e(route('publicExam.index')); ?>" class="btn-hero primary">
...
<!-- Featured Lectures Section -->
<?php if(isset($featuredLectures) && $featuredLectures->count() > 0): ?>
<section class="featured-lectures-section">
    <div class="container">
        ...
        <div class="row g-4">
            <?php $__currentLoopData = $featuredLectures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lecture): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-4 col-md-6">
                <div class="lecture-card">
                    <div class="lecture-image">
                        ...
                        ?>
                        <?php if($lectureImageUrl): ?>
                            <img src="<?php echo e($lectureImageUrl); ?>" 
                    ...
                    <div class="lecture-content">
                        ...
                        <h5><?php echo e($lecture->title); ?></h5>
                        <?php if($lecture->description): ?>
                        <p><?php echo e(Str::limit($lecture->description, 100)); ?></p>
                        <?php endif; ?>
                        <div class="lecture-meta">
                            <span>
                                <i class="fas fa-graduation-cap"></i>
                                <?php echo e($lecture->grade); ?>

                            </span>
                            <?php if($lecture->month): ?>
                            <span>
                                <i class="fas fa-calendar"></i>
                                <?php echo e($lecture->month->name); ?>

                            </span>
                            <?php endif; ?>
                            <span>
                                <i class="fas fa-eye"></i>
                                <?php echo e($lecture->views ?? 0); ?> مشاهدة
                            </span>
                        </div>
                        <?php if(auth()->guard('student')->check()): ?>
                            <?php
                            ...
                            <?php if($hasSubscription): ?>
                                <a href="<?php echo e(route('lecture', ['lecture_id' => $lecture->id])); ?>" class="lecture-btn">
                                    <i class="fas fa-play me-2"></i> شاهد المحاضرة
                                </a>
                            <?php else: ?>
                                <?php if($deactivationReason): ?>
                                    <button class="lecture-btn" disabled style="opacity: 0.6; cursor: not-allowed;" title="<?php echo e($deactivationReason); ?>">
                                        <i class="fas fa-lock me-2"></i> <?php echo e($deactivationReason); ?>
                            ...
                            <?php endif; ?>
                        <?php else: ?>
                            <a href="<?php echo e(route('studentLogin')); ?>" class="lecture-btn">
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\A-Tech\Downloads\archiveGzNa7\resources\views/front/index.blade.php ENDPATH**/ ?>