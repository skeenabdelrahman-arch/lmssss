        ...
        <div class="auth-form-side">
            ...
            <?php if(session()->has('error')): ?>
                <div class="alert alert-danger border-0 rounded-pill px-4">
                    <small><b>عذراً!</b> <?php echo e(session()->get('error')); ?></small>
                </div>
            <?php endif; ?>
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="email" name="email" class="form-control custom-input <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>" 
                           value="<?php echo e(old('email')); ?>" required placeholder="admin@example.com">
...
<img src="<?php echo e(asset('storage/front/assets/images/teacher_image.jpg')); ?>" alt="Logo" class="visual-logo">
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\A-Tech\Downloads\archiveGzNa7\resources\views/auth/login.blade.php ENDPATH**/ ?>